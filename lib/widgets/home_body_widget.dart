...
class HomeBodyWidget extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          const Expanded(child: Text('My bKash')),
                          InkWell(
                            child: Text(
                              'See All',
                              style: AppTheme.homeHintText,
                            ),
                            onTap: () {
                              showCustomBottomSheet(
                                  context, mybKashList, 'Recent activities');
                            },
                          )
                        ],
                      ),
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            child: CardWidget(
                                ...
                                image: mybKashList[index].icon),
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DetailsPage(
                                          menu: mybKashList[index],
                                        )),
                              );
                            },
                          );
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              showCustomBottomSheet(
                                  context, suggestionList, 'All Suggestions');
                            },
                          )
                        ],
                      ),
  ...
  void showCustomBottomSheet(
      BuildContext context, List<HomeMenu> list, String title) {
            ...
            children: [
              ...
              Expanded(
                ...
                children: List.generate(list.length, (index) {
                  return Center(
                    child: CardWidget(
                        title: list[index].title, image: list[index].icon),
                  );
                }),
              ))
            ],
